...
app.get('/team_stats', function(req, res) {
	...
	var lostgames = 'SELECT COUNT(*) FROM football_games WHERE visitor_score > home_score;';
	var wingames = 'SELECT COUNT(*) FROM football_games WHERE visitor_score < home_score;';
	db.task('get-everything', task => {
		return task.batch([
			task.any(query1),
			task.any(lostgames),
